...
st.title("💬 Elephant AI Asistance") 
...
if user_input := st.chat_input("Input your question!"):
    ...
    with st.spinner("Thinking ..."):
        ...
        template = '''
        Your name is ElephantAI. You are an helpful and friendly assistant. Please provide a short answer to fulfill the following request. Reply in short and precise.
        Request: {question}
        ...
        with thinking_placegolder:
            st_callback = StreamlitCallbackHandler(st.container())
        answer=chain.run(final_prompt,callbacks=[st_callback])
